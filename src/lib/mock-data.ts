...
export const MOCK_NC: NoConformidad[] = [
  ...
  },
  {
    ...
    molde_id: 'mol-4', tipo_defecto: 'despunte', detalle: 'Despunte menor en base del poste',
  ...
  },
  {
    ...
    fecha_deteccion: '2026-03-23', origen: 'manual', tipo_defecto: 'fisura_menor',
  ...
  // HORMISUR Parral NC
  {
    ...
    molde_id: 'mol-10', tipo_defecto: 'fisura_menor', detalle: 'Fisura superficial en zona de empotramiento',
  ...
  },
  {
    ...
    fecha_deteccion: '2026-04-01', origen: 'manual', tipo_defecto: 'fisura_menor',
  ...
  },
  {
    ...
    fecha_deteccion: '2026-04-03', origen: 'manual', tipo_defecto: 'fisura_menor',
  ...
  },
  {
    ...
    tipo_defecto: 'fisura_menor', detalle: 'Fisura superficial longitudinal en cara exterior, <0.15mm',
  ...
  },
  {
    ...
    tipo_defecto: 'fisura_mayor', detalle: 'Fisura de flexión detectada en zona de empotramiento durante desmolde',
...
export const MOCK_ENSAYOS: EnsayoCompresion[] = [
  { id: 'ens-1', planta_id: 'plt-tmc', jornada_id: 'jrn-1', fecha_muestra: '2026-02-15', tipo_hormigon: 'G25', resultado_7d_mpa: 22.5, resultado_28d_mpa: 33.2, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-2', planta_id: 'plt-tmc', fecha_muestra: '2026-01-20', tipo_hormigon: 'G25', resultado_7d_mpa: 21.0, resultado_28d_mpa: 31.8, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-3', planta_id: 'plt-tmc', fecha_muestra: '2025-12-15', tipo_hormigon: 'G25', resultado_7d_mpa: 20.3, resultado_28d_mpa: 30.1, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-4', planta_id: 'plt-tmc', fecha_muestra: '2025-11-18', tipo_hormigon: 'G25', resultado_7d_mpa: 19.8, resultado_28d_mpa: 28.5, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-5', planta_id: 'plt-prl', jornada_id: 'jrn-8', fecha_muestra: '2026-02-28', tipo_hormigon: 'G25', resultado_7d_mpa: 18.2, resultado_28d_mpa: 27.0, laboratorio: 'Lab. Materiales Linares', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-6', planta_id: 'plt-hbl', fecha_muestra: '2026-03-10', tipo_hormigon: 'G25', resultado_7d_mpa: 23.1, resultado_28d_mpa: 34.0, laboratorio: 'Lab. Materiales Biobío', cumple: true, created_by: 'usr-hb-ec' },
  { id: 'ens-7', planta_id: 'plt-osr', jornada_id: 'jrn-10', fecha_muestra: '2026-03-01', tipo_hormigon: 'G25', resultado_7d_mpa: 22.0, resultado_28d_mpa: 32.5, laboratorio: 'Lab. Materiales Osorno', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-8', planta_id: 'plt-osr', fecha_muestra: '2026-02-10', tipo_hormigon: 'G25', resultado_7d_mpa: 20.8, resultado_28d_mpa: 31.0, laboratorio: 'Lab. Materiales Osorno', cumple: true, created_by: 'usr-hs-ec' },
  // Nuevas empresas
  { id: 'ens-9', planta_id: 'plt-hbl', jornada_id: 'jrn-11', fecha_muestra: '2026-03-15', tipo_hormigon: 'G25', resultado_7d_mpa: 22.8, resultado_28d_mpa: 33.5, laboratorio: 'Lab. Materiales Biobío', cumple: true, created_by: 'usr-hb-ec' },
  { id: 'ens-10', planta_id: 'plt-frt', jornada_id: 'jrn-12', fecha_muestra: '2026-03-12', tipo_hormigon: 'G25', resultado_7d_mpa: 21.5, resultado_28d_mpa: 32.0, laboratorio: 'Lab. Materiales Puerto Montt', cumple: true, created_by: 'usr-hb-ec' },
  { id: 'ens-11', planta_id: 'plt-fco', jornada_id: 'jrn-13', fecha_muestra: '2026-03-18', tipo_hormigon: 'G25', resultado_7d_mpa: 23.0, resultado_28d_mpa: 34.2, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-fc-ec' },
  { id: 'ens-12', planta_id: 'plt-fpa', jornada_id: 'jrn-14', fecha_muestra: '2026-03-14', tipo_hormigon: 'G25', resultado_7d_mpa: 20.5, resultado_28d_mpa: 30.8, laboratorio: 'Lab. Materiales Puerto Montt', cumple: true, created_by: 'usr-fc-ec' },
  { id: 'ens-13', planta_id: 'plt-hvl', jornada_id: 'jrn-15', fecha_muestra: '2026-03-10', tipo_hormigon: 'G25', resultado_7d_mpa: 22.2, resultado_28d_mpa: 33.0, laboratorio: 'Lab. Materiales Valdivia', cumple: true, created_by: 'usr-hv-ec' },
  { id: 'ens-14', planta_id: 'plt-hnr', jornada_id: 'jrn-16', fecha_muestra: '2026-03-08', tipo_hormigon: 'G25', resultado_7d_mpa: 21.8, resultado_28d_mpa: 32.6, laboratorio: 'Lab. Materiales Coyhaique', cumple: true, created_by: 'usr-hn-ec' },
  // === ABRIL 2026 ensayos ===
  { id: 'ens-15', planta_id: 'plt-tmc', jornada_id: 'jrn-a01', fecha_muestra: '2026-04-05', tipo_hormigon: 'G25', resultado_7d_mpa: 23.0, resultado_28d_mpa: 34.1, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-16', planta_id: 'plt-prl', jornada_id: 'jrn-a04', fecha_muestra: '2026-04-08', tipo_hormigon: 'G25', resultado_7d_mpa: 19.0, resultado_28d_mpa: 28.2, laboratorio: 'Lab. Materiales Linares', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-17', planta_id: 'plt-osr', jornada_id: 'jrn-a06', fecha_muestra: '2026-04-06', tipo_hormigon: 'G25', resultado_7d_mpa: 22.5, resultado_28d_mpa: 33.8, laboratorio: 'Lab. Materiales Osorno', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-18', planta_id: 'plt-hbl', jornada_id: 'jrn-a08', fecha_muestra: '2026-04-04', tipo_hormigon: 'G25', resultado_7d_mpa: 23.5, resultado_28d_mpa: 35.0, laboratorio: 'Lab. Materiales Biobío', cumple: true, created_by: 'usr-hb-ec' },
  { id: 'ens-19', planta_id: 'plt-frt', jornada_id: 'jrn-a11', fecha_muestra: '2026-04-06', tipo_hormigon: 'G25', resultado_7d_mpa: 21.0, resultado_28d_mpa: 31.5, laboratorio: 'Lab. Materiales Puerto Montt', cumple: true, created_by: 'usr-hb-ec' },
  { id: 'ens-20', planta_id: 'plt-hvl', jornada_id: 'jrn-a13', fecha_muestra: '2026-04-05', tipo_hormigon: 'G25', resultado_7d_mpa: 22.8, resultado_28d_mpa: 33.5, laboratorio: 'Lab. Materiales Valdivia', cumple: true, created_by: 'usr-hv-ec' },
  { id: 'ens-21', planta_id: 'plt-hnr', jornada_id: 'jrn-a16', fecha_muestra: '2026-04-04', tipo_hormigon: 'G25', resultado_7d_mpa: 20.5, resultado_28d_mpa: 30.2, laboratorio: 'Lab. Materiales Coronel', cumple: true, created_by: 'usr-hn-ec' },
  { id: 'ens-22', planta_id: 'plt-fco', jornada_id: 'jrn-a19', fecha_muestra: '2026-04-05', tipo_hormigon: 'G25', resultado_7d_mpa: 23.2, resultado_28d_mpa: 34.5, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-fc-ec' },
  { id: 'ens-23', planta_id: 'plt-fpa', jornada_id: 'jrn-a22', fecha_muestra: '2026-04-06', tipo_hormigon: 'G25', resultado_7d_mpa: 21.2, resultado_28d_mpa: 31.0, laboratorio: 'Lab. Materiales Puerto Montt', cumple: true, created_by: 'usr-fc-ec' },
  // === MAYO 2026 ensayos ===
  { id: 'ens-24', planta_id: 'plt-tmc', jornada_id: 'jrn-m01', fecha_muestra: '2026-05-14', tipo_hormigon: 'G25', resultado_7d_mpa: 23.8, resultado_28d_mpa: 35.2, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-25', planta_id: 'plt-prl', jornada_id: 'jrn-mp02', fecha_muestra: '2026-05-14', tipo_hormigon: 'G25', resultado_7d_mpa: 19.5, resultado_28d_mpa: 29.0, laboratorio: 'Lab. Materiales Linares', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-26', planta_id: 'plt-osr', jornada_id: 'jrn-mo02', fecha_muestra: '2026-05-14', tipo_hormigon: 'G25', resultado_7d_mpa: 22.0, resultado_28d_mpa: 32.8, laboratorio: 'Lab. Materiales Osorno', cumple: true, created_by: 'usr-hs-ec' },
  { id: 'ens-27', planta_id: 'plt-hbl', jornada_id: 'jrn-mh02', fecha_muestra: '2026-05-14', tipo_hormigon: 'G25', resultado_7d_mpa: 24.0, resultado_28d_mpa: 35.5, laboratorio: 'Lab. Materiales Biobío', cumple: true, created_by: 'usr-hb-ec' },
  { id: 'ens-28', planta_id: 'plt-frt', jornada_id: 'jrn-mf02', fecha_muestra: '2026-05-15', tipo_hormigon: 'G25', resultado_7d_mpa: 21.8, resultado_28d_mpa: 32.2, laboratorio: 'Lab. Materiales Puerto Montt', cumple: true, created_by: 'usr-hb-ec' },
  { id: 'ens-29', planta_id: 'plt-hvl', jornada_id: 'jrn-mv02', fecha_muestra: '2026-05-14', tipo_hormigon: 'G25', resultado_7d_mpa: 23.0, resultado_28d_mpa: 34.0, laboratorio: 'Lab. Materiales Valdivia', cumple: true, created_by: 'usr-hv-ec' },
  { id: 'ens-30', planta_id: 'plt-hnr', jornada_id: 'jrn-mn02', fecha_muestra: '2026-05-14', tipo_hormigon: 'G25', resultado_7d_mpa: 21.5, resultado_28d_mpa: 31.8, laboratorio: 'Lab. Materiales Coronel', cumple: true, created_by: 'usr-hn-ec' },
  { id: 'ens-31', planta_id: 'plt-fco', jornada_id: 'jrn-mc02', fecha_muestra: '2026-05-14', tipo_hormigon: 'G25', resultado_7d_mpa: 22.5, resultado_28d_mpa: 33.0, laboratorio: 'Lab. Materiales Temuco', cumple: true, created_by: 'usr-fc-ec' },
  { id: 'ens-32', planta_id: 'plt-fpa', jornada_id: 'jrn-mq02', fecha_muestra: '2026-05-15', tipo_hormigon: 'G25', resultado_7d_mpa: 20.8, resultado_28d_mpa: 30.5, laboratorio: 'Lab. Materiales Puerto Montt', cumple: true, created_by: 'usr-fc-ec' },
...
export const MOCK_DESPACHOS: Despacho[] = [
  {
    ...
    destinatario: 'Subestación Temuco Norte — SAESA',
    ...
    fecha_recepcion: '2026-02-21',
    nombre_receptor: 'Carlos Pino — SAESA Temuco',
  ...
  },
  {
    ...
    destinatario: 'Obra Vilcún — SAESA',
    transportista: 'Transportes del Sur Ltda.',
    ...
    estado_recepcion: 'con_danos',
    fecha_recepcion: '2026-04-11',
    nombre_receptor: 'Luis Fuentes — SAESA Vilcún',
    fotos_recepcion_urls: [],
  ...
  },
  {
    ...
    destinatario: 'Subestación Concepción Sur — SAESA',
    transportista: 'Logística Biobío S.A.',
